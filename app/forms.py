...
class PoemForm(Form):
    ...
    generations = IntegerField('generations', validators=[DataRequired()], default=2)
    ...
    starting_population_size = IntegerField('sp_size', validators=[DataRequired()], default=20)
